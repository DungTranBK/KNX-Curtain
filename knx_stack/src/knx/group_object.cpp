...
bool GroupObject::responseUpdateEnable()
{
    ...
    return bitRead(sys_be16_to_cpu(_table->_tableData[_asap]), 15) > 0;
}
...
bool GroupObject::transmitEnable()
{
    ...
    return bitRead(sys_be16_to_cpu(_table->_tableData[_asap]), 14) > 0 ;
}
...
bool GroupObject::valueReadOnInit()
{
    ...
    return bitRead(sys_be16_to_cpu(_table->_tableData[_asap]), 13) > 0;
}
...
bool GroupObject::writeEnable()
{
    ...
    return bitRead(sys_be16_to_cpu(_table->_tableData[_asap]), 12) > 0 ;
}
...
bool GroupObject::readEnable()
{
    ...
    return bitRead(sys_be16_to_cpu(_table->_tableData[_asap]), 11) > 0;
}
...
bool GroupObject::communicationEnable()
{
    ...
    return bitRead(sys_be16_to_cpu(_table->_tableData[_asap]), 10) > 0;
}
...
Priority GroupObject::priority()
{
    ...
    return (Priority)((sys_be16_to_cpu(_table->_tableData[_asap]) >> 6) & (3 << 2)) ;
}
...
{
    uint8_t code = lowByte(sys_be16_to_cpu(_table->_tableData[_asap]));
